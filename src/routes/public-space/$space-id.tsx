...
function PublicSpace() {
  ...
  const { data: projects, isPending: projectsPending } = useQuery(Project, { mode: 'public' });
  const { data: tasks, isPending: tasksPending, error: tasksError } = useQuery(Task, { mode: 'public' });
  ...
  return (
    <div className="min-h-screen ">
      ...
      {(projectsPending || (tasksPending && !tasksError) || (periodsPending && !periodsError)) && <div className="text-center py-16">Loading…</div>}
          ...
          {tasksError ? (
            <div className="text-center py-16">
              ...
              <p className="text-gray-500">
                The Tasks schema is not yet deployed to this space. Please check back later.
              </p>
            </div>
          ) : tasks && tasks.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-500">There are currently no public tasks available to explore.</p>
            </div>
          )}
        </div>
